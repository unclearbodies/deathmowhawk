...
<body>
  ...
  <div id="boot-screen">
    ...
    <div class="boot-sequence">
      <div class="header">
        <div class="logo">
          <img src="images/angel.png" alt="GRAVE OS Logo">
        </div>
  ...
  <div id="content-wrapper" style="display: none; filter: blur(5px);">
    <div id="logo">
      <img src="images/angel.png" alt="Logo">
      <div id="logo-text">grave.sh</div>
    </div>

    <div id="main-content">
      <div id="names-list">
        <div class="profile-name" data-name="cute">cute</div>
        <div class="profile-name" data-name="shy">shy</div>
        <div class="profile-name" data-name="motori">motori</div>
        <div class="profile-name" data-name="hardline">hardline</div>
        <div class="profile-name" data-name="romanc3">romance</div>
        <div class="profile-name" data-name="y6t">y6t</div>
        <div class="profile-name" data-name="batman">batman</div>
      </div>
  ...
  <div id="audio-player">
    <div class="title-bar">
      <span>GRAVE.SH Media Player</span>
